...
survey_design <- survey_design %>%
  mutate(
    poverty   = factor(ifelse(Poverty != "NotPoor", 1, 0),
                       levels = c(0, 1),
...
```{r, echo=FALSE}
res <- tidy(interaction_logit_model)
```
...
```{r, echo=FALSE}
res <- tidy.svyVGAM(multinomial_model, exponentiate = FALSE, conf.int = FALSE)
```
